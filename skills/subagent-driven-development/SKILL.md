...
digraph process {
    ...
    "Use js-super:finishing-a-development-branch" [shape=box style=filled fillcolor=lightgreen];
    ...
    "Dispatch final code reviewer subagent for entire implementation" -> "Use js-super:finishing-a-development-branch";
}
```
