...
## Conversation Language Mirroring (REQUIRED)

When you call `TaskCreate` (or any task-creating tool), the task `subject` and `description` MUST be written in the **same primary language the user uses in this conversation**:

- If the user converses in Korean → write task subject/description in Korean
