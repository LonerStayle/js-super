...
### [2026-08-15 16:10] [코드-수정] (trivial)
- **id**: CH-20260815-101
- **이유**: fixture 번호 충돌 해소 — main 머지 시 서술 수준 / 용어집 피처가 각각 선점한 H16 과 겹쳐 본 피처 fixture 를 H19 로 rename
- **무엇이**: skills/js-super-sub-driven/tests/H19-clean-verify/ (구 H16-clean-verify) + README 제목 1줄 + CLAUDE.md 참조 2줄 + tests/README.md 인덱스 등재
